...
const GAS_WEBAPP_URL = "https://script.google.com/macros/s/AKfycbxuNlp2D_bnu4UxBYxFyj1GrHLI74onRqds0u5f2M1oo42i9Bp1Lo-xrmaM_gK4-2r3Hg/exec";
...
export default function App() {
  ...
  const [dia, setDia] = useState(""); // 数値入力（文字列保持→送信時にNumber化）
